...
/**
 * Interface pour interagir avec la table Playlist de la base de donnees.
 * $options = [
	'select' => ['idPlaylist', 'NomPlaylist'], // Champs a retourner
	'count' => 1,                               // compter le nombre de chaque resultat
	'groupBy' => 'Utilisateur',                 // Champ de group
	'orderBy' => 'DateDerniereModification',    // Champ de tri
 ...
 */
function dPlaylist_get(array $options)
{
	...
	$countSql = "SELECT COUNT(*) AS Total FROM Playlist";
